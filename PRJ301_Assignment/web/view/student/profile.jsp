<%-- 
    Document   : profile
    Created on : Mar 19, 2024, 5:13:49 AM
    Author     : Vu Minh Quan
--%>
...
<html>
    ...
    <body>
        <div class="container_header">
            ...
            <h1 class="title">Student's profile</h1>
        ...
        <table>
            ...
            <tr>
                <td>
                    <h2>User detail</h2>
                    <a href="attendstudent?id=${requestScope.sID}">Course attendance</a> |
                    <a href="grade?id=${requestScope.sID}">Grade</a> 
                </td>
                <td></td>

            </tr>
            <c:forEach items="${requestScope.arrS}" var="s">
                <tr>
                    <td>
                        <b>Login</b>
                    </td>
